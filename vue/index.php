        ...
        <ul class="navbar-menu">
          <li class="navbar-item logo">
            <a href="#" class="navbar-link">
              <span class="navbar-title">Tanguy Vallot</span>
          ...
          <li class="navbar-item">
            <a href="formation.html" class="navbar-link">
              <i class="fas fa-graduation-cap navbar-icon"></i>
              <span class="navbar-title">Formation</span>
            </a>
          </li>
          <li class="navbar-item">
            <a href="/CV_Vallot_Tanguy.pdf" class="navbar-link">
              <i class="fas fa-user navbar-icon"></i>
              <span class="navbar-title">Mon CV</span>
            </a>
          </li>
          <li class="navbar-item">
